...
- Classification by planning nature
...
- Normative or best-practice references

### 📁 Bibliographic References
A consolidated list of legal, institutional, and academic sources used to justify
minimum components and classifications.
...
2. Extract the structural components explicitly present in each document  
3. Compare extracted components with the UPICEF minimum reference set  
4. Calculate completeness scores  
5. Document structural gaps and strengths  
...
It is a **foundational diagnostic tool**.
...
- Component names may vary
- Additional components may be added
- Legal sources may differ across countries
